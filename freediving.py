...
def plot_buoyancy_force_kgf(params):
        ...
        for d in depths:
            if d < 0:  # Above surface: no buoyancy
                ...
                total_displacement_volume = (
                    ...
                    + snorkel_volume
                ) * 1e-6 - weight_volume  # Convert to m^3, subtract weight volume

                # Calculate forces
                F_buoyancy = total_displacement_volume * params["seawater_density"] * 9.81  # Newtons
                F_weight = (params["mass"] + params["wetsuit_mass"] + params["lead_weight"]) * 9.81  # Newtons
...
plot_buoyancy_force_kgf(params)
